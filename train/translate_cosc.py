#!/usr/bin/env python3
"""Translate raw_questions_EN_balanced to 7 languages using Tower-Plus-2B-GGUF."""
...
def translate_one(model, text, target_lang):
...
def translate_language(model, lang_code, target_lang_name, en_entries, resume, checkpoint_every=100):
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Translate COSC raw_questions to multiple languages using Tower-Plus-2B-GGUF."
    )
    parser.add_argument(
        "--langs",
        nargs="+",
